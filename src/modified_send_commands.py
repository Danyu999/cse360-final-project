...
##### This file is the "experimental file".  When I figure out how to do the stuff I am trying in
##### this file I update the send_commands.py with the contents of this file.


''' To start this file, use the same instructions as listed in send_commands.py '''
